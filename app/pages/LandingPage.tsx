...
import { MessageSquare, Phone, Video, ArrowRight, Check, Users, Briefcase, Globe, LinkIcon } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl text-gray-600 mb-8">
                Connect with chat, calls, video calls, and securely expose your local servers.
              </p>
              <Link
                to="/register"
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-100">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-8">How to Use RealSync</h2>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-8">Secure Tunnel: Simplified Development</h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl font-semibold mb-4">Expose your local server to the world</h3>
                <p className="text-gray-600 mb-4">
                  Our secure tunnel tool allows you to expose a local server to the Internet through a secure connection. Ideal for development, testing, and demonstrations.
                </p>
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <pre className="text-sm">
                  <code>
                    $ realsync-tunnel start 8080<br />
                    Tunnel started at: https://demo.realsync-tunnel.com<br />
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-100">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-8">Implement Chat on Your Website</h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl font-semibold mb-4">Simple Chat Integration</h3>
                <p className="text-gray-600 mb-4">
                  Add our real-time chat to your website with just a few lines of code. Customize the appearance to match your brand and start interacting with your visitors instantly.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <Check className="h-5 w-5 text-green-500 mr-2" />
              ...
              <div className="bg-white p-4 rounded-lg shadow-lg">
                <div className="mb-4">
                  <h4 className="text-lg font-semibold mb-2">Implementation Code</h4>
...
<div id="chat-container"></div>`}
                ...
                <div className="border rounded-lg p-3">
                  <div className="bg-blue-600 text-white p-2 rounded-t-lg">Live Chat</div>
                  <div className="h-32 bg-gray-100 p-2 overflow-y-auto">
                    <div className="mb-2">
                      <span className="font-semibold">User:</span> Hello, how can I help you?
                    </div>
                    <div className="mb-2">
                      <span className="font-semibold">Visitor:</span> I have a question about your services.
                    </div>
                  </div>
                  <div className="mt-2">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-8">Plans and Pricing</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <PricingCard
                title="Basic"
                price="9.99"
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-100">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Ready to revolutionize your communication and development?</h2>
...
function PricingCard({ title, price, features, highlighted = false }: PricingCardProps) {
  return (
    <div className={`bg-white p-4 rounded-lg shadow-md ${highlighted ? 'border-2 border-blue-500 relative' : ''}`}>
      {highlighted && (
      ...
      <p className="text-3xl font-bold text-center mb-4">${price}<span className="text-lg text-gray-500">/month</span></p>
